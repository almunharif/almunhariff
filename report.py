...
print(Y+' ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
print("""
\033[1;33m[Suicide and self-harm[𝟭]\t\t\033[2;36m
 [Pretending to be a celebrity [𝟮] \t\t  \033[2;31m
 [Inappropriate profile information[𝟯]\n   \033[232m[\033[2;32mUser may be younger than 13 years old[𝟰]
\033[2;35m\t\tlast[𝟱] """)
print(B+' ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
fl=int(input('➣'))
...
K = '\033[1;94m'
L = "\033[1;95m"
sessionid=input(A+" ("+E+"⌯"+A+")"+C+ " 𝗦𝗘𝗦𝗦𝗜𝗢𝗡𝗜𝗗 : "+E)
target=input(A+" ("+E+"⌯"+A+")"+C+ " 𝗨𝗦𝗘𝗥 T𝗛𝗘 𝗩𝗜𝗖𝗧𝗜𝗠 : "+E)
slp=int(input(A+" ("+E+"⌯"+A+")"+C+ " C𝗛𝗢𝗢𝗦𝗘 𝗙𝗥𝗢𝗠 [5] 𝗧𝗢 [10]   : "+E))
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36) Gecko/20100101 Firefox/91.0',
'Accept': '*/*',
'Accept-Language': 'ar,en-US;q=0.7,en;q=0.3',
'Accept-Encoding': 'gzip, deflate',
...
while True:
	...
	if 'Thanks for your feedback' in req.text:
		print(f'\r[{Fore.MAGENTA}${Fore.RESET}] {Fore.GREEN}𝗥𝗘𝗣𝗢𝗥𝗧𝗦 [{done}]{Fore.RESET} | {Fore.RED}𝗥𝗘𝗣𝗢𝗥𝗧𝗦 [{error}]{Fore.RESET}',end=' ')
		done+=1
		...
		exit("[!] Go to @VlP_12 on Telegram and Tell filza this error to make the update of tool batter")